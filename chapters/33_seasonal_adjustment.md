...
```{figure} /_static/figures/figure_08_placeholder.png
:name: fig-m2-spectra
:align: center

Figure 8: Spectral densities of seasonally adjusted and unadjusted M2, 1959:1–1986:2.
```

```{figure} /_static/figures/figure_09_placeholder.png
:name: fig-ar-coefficients
:align: center

Figure 9: Autoregressive coefficients for seasonally adjusted and unadjusted M2.
```

```{figure} /_static/figures/figure_10_placeholder.png
:name: fig-filter-comparison
:align: center

Figure 10: Values of filters $b^{nsa}(L)$ and $b^{sa}(L)$.
```

```{figure} /_static/figures/figure_11_placeholder.png
:name: fig-transfer-magnitude
:align: center

Figure 11: Magnitude of transfer function from innovations in M2 to $y_t$.
```

```{figure} /_static/figures/figure_12_placeholder.png
:name: fig-transfer-phase
:align: center

Figure 12: Phase of transfer function from innovations in M2 to $y_t$.
```
